...
from scripts.probe_gui_owl_single import MAX_INPUT_BYTES, parse_request  # noqa: E402


class WorkerTests(unittest.TestCase):
    def request(self):
        return dict(version=1, request_id="gui-inert-test", context_digest="a" * 64,
    ...
    def test_cli_missing_opt_in_does_not_load_model(self):
        result = subprocess.run([sys.executable, "-I", "-B", str(ROOT / "scripts/probe_gui_owl_single.py")],
