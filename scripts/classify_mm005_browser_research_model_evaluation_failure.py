"""Recompute or check the MM-005 Browser Research eval v1 failure classification."""
...
def main() -> int:
    ...
    local_verification = failure.verify_local_attempt_owner_if_present(ROOT)
        ...
        json.dumps(
            {
                ...
                "local_owner_tree_verified": local_verification[
