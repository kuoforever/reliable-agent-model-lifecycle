"""One v3-aware completion diagnostic on the pinned reference; no desktop or network API."""
...
WORKER_SHA = "f0cae366ea330951e7a8f0349f4ab739a14370df85ce678876c331915917b563"
SOURCE_SHA = "c3cf519cadef0e1f55c6457c7151d67553b8c87f70d79a128373dd78d9d70a1a"
REQUEST_ID = "public-source-summary-completion-20260908"


def validate_response(response, request, exit_code):
    if type(response) is not dict or type(response.get("version")) is not int or response["version"] != 3:
    ...
    if response.get("status") == "ERROR":
        ...
        return
    fixed = dict(version=3, status="OK", request_id=request["request_id"],
...
def main():
    ...
    parser.add_argument("--one-completion-diagnostic", action="store_true", required=True)
    parser.parse_args()
    receipt = run(ROOT / "work/public-source-summary-20260907/request.json",
                  ROOT / "work/public-source-summary-completion-20260908")
