"""Build or check the MM-005 Browser Research model-evaluation protocol."""
...
from scripts import (  # noqa: E402
    prepare_mm005_browser_research_adapter_verifier_implementation as implementation_prepare,
)
from scripts import (  # noqa: E402
...
def protocol_inputs() -> dict[str, Any]:
    ...
    records, _source_bindings, _dataset_receipts = adapter_protocol.dataset_context(
        output_payloads
    )
    return {
