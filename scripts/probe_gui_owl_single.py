"""One experimental local image proposal over bounded stdin/stdout; no desktop API."""
...
def generate(request, png, count):
    ...
    messages = [
        ...
        {"role": "user", "content": [
            {"type": "image", "image": "captured-synthetic-fixture"},
            {"type": "text", "text": "Click the center of the Observation target button."},
        ]},
    ]
