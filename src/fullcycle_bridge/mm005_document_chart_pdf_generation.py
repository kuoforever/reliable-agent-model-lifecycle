"""Fail-closed execution contract for MM-005 synthetic data generation."""
...
EXECUTION_GATE_ID = "MM-005-document-chart-pdf-data-generation-execution-v1"
NEXT_GATE = "MM-005-document-chart-pdf-adapter-verifier-protocol-v1"

PROTOCOL_PATH = "configs/mm005_document_chart_pdf_data_generation_v1.json"
...
REQUIRED_GATES = (
    ...
    "exact_output_tree",
    "independent_readback_validation",
...
class MM005GenerationError(ValueError):
...
def expected_protocol(
    *,
    ...
    return {
        "mm005_document_chart_pdf_generation_protocol_version": (
            GENERATION_PROTOCOL_VERSION
        ),
        "gate_id": GATE_ID,
        "freeze_status": freeze_status,
        "decision": "one_shot_model_free_synthetic_data_materialization",
        ...
        "execution_plan": {
            ...
            "independent_readback_validation_required": True,
...
def validate_output_payloads(
    ...
    *,
    ...
    expected_validation = {
        ...
        "source_artifact_count": data.PDF_COUNT,
...
def build_evidence(
    *,
    ...
    return {
        "mm005_document_chart_pdf_generation_evidence_version": EVIDENCE_VERSION,
...
def _json_object(payload: bytes, location: str) -> Mapping[str, Any]:
    try:
        ...
        raise MM005GenerationError("JSON_INVALID", location) from exc
...
def _fail(code: str, location: str = "$") -> NoReturn:
    raise MM005GenerationError(code, location)
