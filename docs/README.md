...
| Browser Research Adapter/Verifier implementation v1 | [MM-005 Browser Research Adapter/Verifier implementation](MM-005-browser-research-adapter-verifier-implementation-v1.md) | Independent Adapter plus strict compiler/Verifier reproduce 32 projections and 224 citation/source/freshness controls exactly; no model execution or Runtime authority |
