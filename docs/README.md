...
| Browser Research generation-failure diagnostic implementation v2 | [MM-005 Browser Research generation-failure diagnostic implementation v2](MM-005-browser-research-model-evaluation-generation-failure-diagnostic-implementation-v2.md) | Sole active compatibility freeze: PR #84 published initial I1 (`e185c76...981b8`) atop exact-head base M2 (`8c679eb...d89c0`); final I2 must uniquely follow I1, preserve both exact-11-path M2 deltas and a non-empty in-slice I1 correction, retain I1 source introductions, bind final bytes to I2, and preserve published-authority preflight, single-component parent creation, post-create revalidation, real guards/lifecycle/atomic owner+genesis, and fail-on-call protected first-heavy regression; no authority or execution |
