...
| Repository CI/LFS zero-bandwidth maintenance v2 | [Maintenance contract](repository-ci-lfs-zero-bandwidth-v2.md) | Active bounded non-lifecycle transport prerequisite: immutable hydrated anchor inheritance for automatic CI, separate acknowledged manual hydration, and zero automatic LFS payload bytes |
