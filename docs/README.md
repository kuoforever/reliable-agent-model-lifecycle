...
| Browser Research generation-failure investigation protocol v1 | [MM-005 Browser Research generation-failure investigation protocol](MM-005-browser-research-model-evaluation-generation-failure-investigation-protocol-v1.md) | Model-free static investigation preregistration freezes the exact fourth record, six controls, input/message reconstruction, evidence layers, outcome-neutral rubric, and conditional new-identity diagnostic routing; investigation is not executed |
