...
| Browser Research model-evaluation recovery protocol v2 | [MM-005 Browser Research recovery protocol](MM-005-browser-research-model-evaluation-recovery-protocol-v2.md) | New-experiment protocol frozen locally with exact v1 semantic preservation, long-path-safe Git blob lineage, atomic owner/genesis, durable chained progress, and model-free exact terminal repair; no v2 execution yet |
