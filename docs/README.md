...
| Browser Research generation-failure diagnostic execution authority v2 | [MM-005 Browser Research generation-failure diagnostic execution authority v2](MM-005-browser-research-model-evaluation-generation-failure-diagnostic-execution-authority-v2.md) | Sole active authority-only gate: the canonical 2,944-byte artifact (`b638a7a7...39f0`) binds I2, four critical dependency receipts, the frozen expected 17-field environment, resource caps, one invocation, and zero retry; the builder and validator separately verify three I2 source receipts, the gate creates no runtime state or attempt, and its exact post-merge successor is execution-v2 |
