...
| Browser Research environment-adaptation protocol v1 | [MM-005 Browser Research protocol](MM-005-browser-research-environment-adaptation-protocol-v1.md) | Frozen model-free static synthetic DOM/screenshot/page-text scope with exact citations, source freshness, prior-content exclusions, and no live browser/network or Runtime authority |
