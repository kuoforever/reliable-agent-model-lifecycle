...
| Browser Research model-evaluation failure classification v2 | [MM-005 Browser Research failure classification v2](MM-005-browser-research-model-evaluation-failure-classification-v2.md) | Three raw formal artifacts and 14 journal frames bind the 4-start/3-completion boundary; root cause remains unauthenticated, retry/result claims stay false, and the next gate is a model-free investigation protocol |
